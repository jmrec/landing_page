        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                ...
                <p className="mx-auto mt-4 max-w-sm text-gray-500">
                    Eddie will personally help you fit the products.
                </p>
                ...
                <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                    ...
                    <div className="pt-10 lg:pt-0 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2">
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                >
                                    ...
                                    <span className="flex-1 text-gray-700">eddie@sugar.plum</span>
                                </a>
                                </li>
                                ...
                                >
                                    ...
                                    <span className="flex-1 text-gray-700">80085</span>
                                </a>
                                </li>
                                ...
                                <address className="-mt-0.5 flex-1 not-italic text-gray-700">
                                    69 Peckley St., Baguio, Philippines
                                </address>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2025 The Eddie G Company</p>
                    </div>
                    </div>
                </div>
                </footer>
